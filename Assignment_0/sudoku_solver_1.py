# each of the 3x3 matrixes that make up a block, used when determining what coordinates belong in what block
...
# function used to print the board with proper formatting
